      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
                <path d="M16 2L28 8V24L16 30L4 24V8L16 2Z" fill="url(#fLogoGrad)" opacity="0.9"/>
                <path d="M16 6L24 10V22L16 26L8 22V10L16 6Z" fill="url(#fLogoGrad2)"/>
                <path d="M16 10L20 12V20L16 22L12 20V12L16 10Z" fill="white" opacity="0.9"/>
                <defs>
                  <linearGradient id="fLogoGrad" x1="4" y1="2" x2="28" y2="30">
                    <stop stopColor="#E8833A"/>
                    <stop offset="1" stopColor="#8B6F47"/>
                  </linearGradient>
                  <linearGradient id="fLogoGrad2" x1="8" y1="6" x2="24" y2="26">
                    <stop stopColor="#E8833A"/>
          ...
          <div className={styles.linksCol}>
            ...
            <ul className={styles.linksList}>
              ...
              <li><Link href="/status">{t('nav.status')}</Link></li>
            </ul>
          </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} TrustChat. {t('footer.rights')}.
          </p>
        </div>
      </div>
    </footer>
